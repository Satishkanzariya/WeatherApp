...
extension displaydata: UITableViewDataSource,UITableViewDelegate{
    
    private func mytablesetviewsetup(){
        mytableview.dataSource = self
        mytableview.delegate = self
        mytableview.register(Wcell.self, forCellReuseIdentifier: "wcell")
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "wcell",for: indexPath) as! Wcell
...
extension displaydata:UISearchBarDelegate{
